        ...
        <div className='bg-neutral h-[50rem] lg:h-[35rem]'>
            <div className='container mx-auto flex flex-col lg:flex-row items-center justify-between py-16 px-0 '>
                <div className='flex flex-col items-start lg:gap-4 gap-1 '>
                    <h1 className='font-semibold lg:text-7xl text-4xl  text-gray'  >{titleone} </h1>
                    <h1 className='text-lemon font-semibold lg:text-6xl text-3xl   lg:ml-0 ml-8'> {titletwo}</h1>
                    <p className='text-grey text-base mt-2'>{paragraph}</p>
                    <button className='bg-lemon text-white  h-11 w-28 rounded lg:ml-0 ml-14 mt-3 '>{button}</button>
                </div>
                <div className=''>
...
//                 <div className='flex flex-col items-start lg:gap-4 gap-1 '>
//                     <h1 className='font-semibold lg:text-7xl text-4xl  text-gray'  >{titleone} </h1>
//                     <h1 className='text-lemon font-semibold lg:text-6xl text-3xl lg:ml-0 ml-6'> {titletwo}</h1>
//                     <p className='text-grey text-base mt-2 '>{paragraph}</p>
