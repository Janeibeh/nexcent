...
const Testc = () => {
  return (
      ...
      <div className='bg-neutral h-[35rem] '>
            <div className='container mx-auto flex flex-col lg:flex-row items-center justify-between py-16 px-0 '>
                <div className='flex flex-col items-start lg:gap-4 gap-1 '>
                    ...
                    <button className='bg-lemon text-white  h-11 w-28 rounded lg:ml-0 ml-24 mt-5 '>Register</button>
                </div>
                {/* <div className=''>
                    <Image src={image} width={391} height={407}  } className='lg:w-96 h-96' />
                </div> */}
            </div>
        </div>
